        ...
        <div class="container">
            <div class="place-nav">
                <ul class="nav" role="tablist">
                    <li>
                        <a href="#" class="nav-link active" data-bs-toggle="tab" data-bs-target="#add_hotel" aria-selected="true" role="tab">
							Edit Hotel
						</a>
                    </li>
                    <li>
                        <a href="#" class="nav-link" data-bs-toggle="tab" data-bs-target="#add_room" aria-selected="false" role="tab" tabindex="-1">
							Edit Room
						</a>
                    </li>
                </ul>
                            ...
                            <form action="{{url('hotel-grid')}}">
                                ...
                                <div class="card shadow-none" id="faq">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <a href="#" class="btn btn-primary btn-sm add-highlight" data-bs-toggle="modal" data-bs-target="#add_faq">
