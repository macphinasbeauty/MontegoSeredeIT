                    ...
                    <div class="card user-sidebar agent-sidebar mb-4 mb-lg-0">
                        ...
                        <div class="card-body user-sidebar-body">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('agent.bookings') }}" class="d-flex align-items-center active">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>#{{ $booking->id }}</td>
                                                    <td>
                                                        <span class="badge bg-{{ $booking->bookable_type === 'App\\Models\\Car' ? 'primary' : ($booking->bookable_type === 'App\\Models\\Hotel' ? 'success' : 'info') }}">
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="#"><i class="fas fa-check"></i> Confirm Booking</a></li>
                                                                @endif
                                                            </ul>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="7" class="text-center py-4">
                                                        ...
                                                        <p class="fs-14 text-muted">You haven't made any bookings yet.</p>
                                                    </td>
                                                </tr>
                                                @endforelse
                                            </tbody>
