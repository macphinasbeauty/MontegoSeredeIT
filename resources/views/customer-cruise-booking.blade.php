                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('customer-cruise-booking')}}" class="fs-14 d-inline-flex align-items-center active">Cruise</a>
                                        </li>
                                        <li>
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#{{ $booking->status }}">#CR-{{ $booking->id }}</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('cruise-details', $booking->bookable->id) }}" class="avatar avatar-lg">
                                                        <img src="{{ $booking->bookable->image ? asset('storage/' . $booking->bookable->image) : URL::asset('build/img/cruise/cruise-01.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{ url('cruise-details', $booking->bookable->id) }}">{{ $booking->bookable->name }}</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">{{ $booking->bookable->departure_port }} - {{ $booking->bookable->destination_port }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 class="fs-14 mb-1">{{ $booking->bookable->cabin_type }}</h6>
                                                <span class="fs-14 fw-normal text-gray-6">{{ $booking->details['guests'] ?? 'N/A' }}</span>
                                            </td>
                                            <td>{{ $booking->bookable->duration_days }} Days, {{ $booking->bookable->duration_days - 1 }} Nights</td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#{{ $booking->status }}"><i class="isax isax-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @empty
                                        <tr>
                                            <td colspan="8" class="text-center">No cruise bookings found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
