                        ...
                        <div class="card-body user-sidebar-body">
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{url('flight-booking')}}" class="fs-14 d-inline-flex align-items-center">Flights</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="{{url('customer-bus-booking')}}" class="fs-14 d-inline-flex align-items-center active">Bus</a>
                                        </li>
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#{{ $booking->status }}">#BB-{{ $booking->id }}</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('bus-details', $booking->bookable->id) }}" class="avatar avatar-lg">
                                                        <img src="{{ $booking->bookable->image ? asset('storage/' . $booking->bookable->image) : URL::asset('build/img/bus/grid/bus-grid-img-1.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{ url('bus-details', $booking->bookable->id) }}">{{ $booking->bookable->name }}</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">{{ $booking->bookable->operator }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{ $booking->details['travellers'] ?? 'N/A' }}</td>
                                            <td>{{ $booking->bookable->route_from }} - {{ $booking->bookable->route_to }}</td>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8" class="text-center">No bus bookings found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
