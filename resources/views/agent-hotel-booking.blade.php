                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium">#HB-{{ str_pad($booking->id, 4, '0', STR_PAD_LEFT) }}</a></td>
                                            <td>
                                                <div>
                                                    <p class="text-dark mb-0 fw-medium fs-14"><a href="#">{{ $booking->bookable->name ?? 'Hotel' }}</a></p>
                                                    <span class="fs-14 fw-normal text-gray-6">{{ $booking->bookable->location ?? 'Location' }}</span>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <h6 class="fs-14 mb-1">{{ $booking->room_type ?? 'Standard Room' }}</h6>
                                                <span class="fs-14 fw-normal text-gray-6">{{ $booking->adults ?? 1 }} Adults{{ $booking->children ? ', ' . $booking->children . ' Child' . ($booking->children > 1 ? 'ren' : '') : '' }}</span>
                                            </td>
                                            <td>{{ $booking->nights ?? 1 }} Day{{ ($booking->nights ?? 1) > 1 ? 's' : '' }}, {{ ($booking->nights ?? 1) - 1 }} Night{{ (($booking->nights ?? 1) - 1) > 1 ? 's' : '' }}</td>
                                        ...
                                        <tr>
                                            <td colspan="9" class="text-center py-4">
                                                ...
                                                <p class="fs-14 text-muted">Your hotel booking history will appear here</p>
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
