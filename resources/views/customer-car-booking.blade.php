                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('customer-car-booking')}}" class="fs-14 d-inline-flex align-items-center active">Cars</a>
                                        </li>
                                        <li>
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#{{ $booking->status }}">#CB-{{ $booking->id }}</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('car-details', $booking->bookable->id) }}" class="avatar avatar-lg">
                                                        <img src="{{ $booking->bookable->image ? asset('storage/' . $booking->bookable->image) : URL::asset('build/img/cars/car-01.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{ url('car-details', $booking->bookable->id) }}">{{ $booking->bookable->name }}</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">{{ $booking->details['car_type'] ?? 'N/A' }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8" class="text-center">No car bookings found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
