                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('agent-bus-booking')}}" class="fs-14 d-inline-flex align-items-center active">Bus</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#upcoming">#BB-1245</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Red Bird Luxury</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#upcoming">#BB-3215</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Elite Ride</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#upcoming">#BB-4581</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Urban Glide</a></p>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#BB-6545</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Route Max</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Ashok Leyland</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#cancelled">#BB-3256</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Trail Star</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Volvo</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#cancelled">#BB-3654</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Enviro Bus</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Volvo</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#BB-1458</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">City Mover</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Tata</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#BB-6589</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">City Shuttle</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Volvo</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#BB-2315</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Volt Voyage</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Tata</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#completed">#BB-5414</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{url('bus-details')}}">Journey Jet</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">Ashok Leyland</span>
                                                    </div>
                                                </div>
                                            </td>
