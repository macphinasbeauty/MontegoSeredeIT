                    ...
                    <div class="col-md-12 mx-auto wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="banner-form-tab">
                            <ul class="nav">
                                ...
                                <li>
                                    <a href="#" class="nav-link active" data-bs-toggle="tab" data-bs-target="#Hotels">
                                ...
                                <li>
                                    <a href="#" class="nav-link" data-bs-toggle="tab" data-bs-target="#Bus">
                                        <i class="fa-solid fa-camera me-2"></i>Bus
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="place-item mb-4 flex-fill">
                    ...
                    <div class="place-content">
                        ...
                        <div class="border-top pt-2 mb-2">
                            <h6 class="d-flex align-items-center">Facillities :<i class="isax isax-home-wifi ms-2 me-2 text-primary"></i><i class="isax isax-scissor me-2 text-primary"></i><i class="isax isax-profile-2user me-2 text-primary"></i><i class="isax isax-wind-2 me-2 text-primary"></i><a href="#" class="fs-14 fw-normal text-default d-inline-block">+2</a></h6>
                        </div>
