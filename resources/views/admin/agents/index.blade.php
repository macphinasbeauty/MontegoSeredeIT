        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Agent Management</h2>
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('admin.agents.index') }}" class="fs-14 d-inline-flex align-items-center active">Agents</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.agent-permissions.index') }}" class="fs-14 d-inline-flex align-items-center">Agent Permissions</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="submenu">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="{{ route('admin.agent-permissions.index') }}" class="btn btn-outline-primary">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $agent->company ?? '-' }}</td>
                                                    <td>
                                                        <span class="badge bg-info">{{ $agent->bookings->count() }} bookings</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="{{ route('admin.agents.show', $agent) }}"><i class="fas fa-eye"></i> View</a></li>
                                                                <li><a class="dropdown-item" href="{{ route('admin.agents.edit', $agent) }}"><i class="fas fa-edit"></i> Edit</a></li>
                                                                <li>
                                                                    <form action="{{ route('admin.agents.destroy', $agent) }}" method="POST" class="d-inline">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" class="dropdown-item text-danger" onclick="return confirm('Are you sure you want to delete this agent?')">
