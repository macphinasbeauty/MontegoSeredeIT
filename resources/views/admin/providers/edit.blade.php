        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-12">
                    <h2 class="breadcrumb-title mb-2">Edit API Provider</h2>
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title mb-0">Edit API Provider</h4>
                            ...
                            <form action="{{ route('admin.providers.update', $provider) }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="type" name="type" required>
                                        <option value="flights" {{ $provider->type == 'flights' ? 'selected' : '' }}>Flights</option>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="api_key" name="api_key" value="{{ $provider->api_key }}">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="api_secret">API Secret</label>
                                    <input type="text" class="form-control" id="api_secret" name="api_secret" value="{{ $provider->api_secret }}">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="endpoint">API Endpoint</label>
                                    <input type="url" class="form-control" id="endpoint" name="endpoint" value="{{ $provider->endpoint }}">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="additional_config">Additional Configuration (JSON)</label>
                                    <textarea class="form-control" id="additional_config" name="additional_config" rows="3">{{ $provider->config ? json_encode($provider->config, JSON_PRETTY_PRINT) : '' }}</textarea>
                                </div>

                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input" id="is_active" name="is_active" {{ $provider->is_active ? 'checked' : '' }}>
