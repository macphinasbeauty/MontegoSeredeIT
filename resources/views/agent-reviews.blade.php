                    ...
                    <div class="card user-sidebar agent-sidebar mb-4 mb-lg-0">
                        ...
                        <div class="card-body user-sidebar-body">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('agent.reviews') }}" class="d-flex align-items-center active">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center py-4">
                                        ...
                                        <h6 class="text-muted">Reviews Management</h6>
                                        <p class="fs-14 text-muted">Review functionality will be available soon.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
