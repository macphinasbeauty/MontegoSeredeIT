                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('customer-hotel-booking')}}" class="fs-14 d-inline-flex align-items-center active">Hotels</a>
                                        </li>
                                        <li>
                            ...
                            <div class="custom-datatable-filter table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="#" class="link-primary fw-medium" data-bs-toggle="modal" data-bs-target="#{{ $booking->status }}">#HB-{{ $booking->id }}</a></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{ url('hotel-details', $booking->bookable->id) }}" class="avatar avatar-lg">
                                                        <img src="{{ $booking->bookable->image ? asset('storage/' . $booking->bookable->image) : URL::asset('build/img/hotels/hotel-01.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <p class="text-dark mb-0 fw-medium fs-14"><a href="{{ url('hotel-details', $booking->bookable->id) }}">{{ $booking->bookable->name }}</a></p>
                                                        <span class="fs-14 fw-normal text-gray-6">{{ $booking->bookable->location }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <h6 class="fs-14 mb-1">{{ $booking->details['room_type'] ?? 'N/A' }}</h6>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8" class="text-center">No hotel bookings found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
