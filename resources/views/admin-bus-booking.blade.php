                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('admin-bus-booking')}}" class="fs-14 d-inline-flex align-items-center active">Bus</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                @forelse($busBookings as $booking)
                                                <tr>
                                                    <td><a href="#" class="link-primary">#B-{{ $booking->id }}</a></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ $booking->bookable ? URL::asset($booking->bookable->image ?? 'build/img/bus/bus-img-01.jpg') : URL::asset('build/img/bus/bus-img-01.jpg') }}" class="rounded me-2" width="50" height="35" alt="Bus">
                                                            <div>
                                                                <div class="fw-medium">{{ $booking->bookable ? ($booking->bookable->name ?? 'Bus Service') : 'Bus Service' }}</div>
                                                                <small class="text-muted">{{ $booking->bookable ? ($booking->bookable->route_from ?? 'From') : 'From' }} → {{ $booking->bookable ? ($booking->bookable->route_to ?? 'To') : 'To' }}</small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>{{ $booking->departure_date ?? $booking->created_at->format('Y-m-d') }}</td>
                                                    <td>{{ $booking->bookable ? ($booking->bookable->departure_time ?? 'N/A') : 'N/A' }}</td>
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center py-4">
                                                        <i class="isax isax-bus fs-48 text-muted mb-3"></i>
                                                        <h6 class="text-muted">No Bus Bookings Found</h6>
                                                        <p class="fs-14 text-muted">Bus bookings will appear here when customers make reservations</p>
                                                    </td>
                                                </tr>
                                                @endforelse
                                            </tbody>
