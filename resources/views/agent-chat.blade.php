                                                    ...
                                                    <div class="d-flex align-items-center ">
                                                        ...
                                                        <div class="chat-actions me-2">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end p-3">
                                                                ...
                                                                <li><a class="dropdown-item" href="#"><i class="isax isax-archive-1 me-2"></i>Archeive Chat</a></li>
                                                ...
                                                <div class="position-relative">
                                                    <div class="d-flex align-items-center">
                                                        <div class="received-message me-2">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <a href="#"><img src="{{URL::asset('build/img/cruise/cruise-14.jpg')}}" alt="image" class="avatar avatar-xxl me-2"></a>
                                                                <a href="#"><img src="{{URL::asset('build/img/cruise/cruise-29.jpg')}}" alt="image" class="avatar avatar-xxl me-2"></a>
                                                                <div class="img-count">
                                                                    <a href="#"><img src="{{URL::asset('build/img/cruise/cruise-13.jpg')}}" alt="image" class="avatar avatar-xxl me-2"></a>
                                                                    <a href="#"><span class="fs-16 fw-medium text-white counts">10+</span></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="chat-actions me-2">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        <a href="#"><span><img src="{{URL::asset('build/img/icons/thumbs-up.svg')}}" alt="image"></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
