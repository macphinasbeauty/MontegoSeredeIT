                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('admin-tour-booking')}}" class="fs-14 d-inline-flex align-items-center active">Tour</a>
                                        </li>
                                        <li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h4 class="mb-0">Tour Bookings</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="#" class="link-primary">#T-{{ $booking->id }}</a></td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ $booking->bookable ? URL::asset($booking->bookable->image ?? 'build/img/tours/tours-01.jpg') : URL::asset('build/img/tours/tours-01.jpg') }}" class="rounded me-2" width="40" height="40" alt="Tour">
                                                            <div>
                                                                <div class="fw-medium">{{ $booking->bookable ? ($booking->bookable->name ?? 'Tour Package') : 'Tour Package' }}</div>
                                                    ...
                                                    <td>{{ $booking->travel_date ?? $booking->created_at->format('Y-m-d') }}</td>
                                                    <td>{{ $booking->duration ?? '7 Days' }}</td>
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center py-4">
                                                        <i class="isax isax-location fs-48 text-muted mb-3"></i>
                                                        <h6 class="text-muted">No Tour Bookings Found</h6>
                                                        <p class="fs-14 text-muted">Tour bookings will appear here when customers make reservations</p>
                                                    </td>
                                                </tr>
                                                @endforelse
                                            </tbody>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card">
                                                    <img src="{{ URL::asset($tour->image ?? 'build/img/tours/tours-01.jpg') }}" class="card-img-top" alt="{{ $tour->name }}" style="height: 150px; object-fit: cover;">
                                                    <div class="card-body p-2">
                                                        <h6 class="card-title mb-1">{{ $tour->name ?? 'Tour Package' }}</h6>
                                                        <p class="card-text small text-muted mb-1">{{ $tour->location ?? 'Location' }}</p>
                                                        <p class="card-text small mb-1">${{ number_format($tour->price ?? 0, 2) }}</p>
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <small class="text-muted">{{ $tour->bookings->count() }} bookings</small>
                                                            <a href="{{ route('add-tour') }}" class="btn btn-sm btn-primary">Edit</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
