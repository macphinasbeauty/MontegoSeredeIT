                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{url('admin-car-booking')}}" class="fs-14 d-inline-flex align-items-center active">Cars</a>
                                        </li>
                                        <li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ $booking->bookable ? URL::asset($booking->bookable->image ?? 'build/img/cars/car-01.jpg') : URL::asset('build/img/cars/car-01.jpg') }}" class="rounded me-2" width="50" height="35" alt="Car">
                                                            <div>
                                                                <div class="fw-medium">{{ $booking->bookable ? ($booking->bookable->name ?? 'Car') : 'Car' }}</div>
                                                    ...
                                                    <td>{{ $booking->pickup_date ?? $booking->created_at->format('Y-m-d') }}</td>
                                                    <td>{{ $booking->return_date ?? $booking->created_at->addDays(5)->format('Y-m-d') }}</td>
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center py-4">
                                                        <i class="isax isax-car fs-48 text-muted mb-3"></i>
                                                        <h6 class="text-muted">No Car Bookings Found</h6>
                                                        <p class="fs-14 text-muted">Car bookings will appear here when customers make reservations</p>
                                                    </td>
                                                </tr>
                                                @endforelse
                                            </tbody>
